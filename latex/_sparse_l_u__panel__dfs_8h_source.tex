...
\hypertarget{_sparse_l_u__panel__dfs_8h_source}{}\label{_sparse_l_u__panel__dfs_8h_source}\index{packages/Eigen.3.3.3/build/native/include/Eigen/src/SparseLU/SparseLU\_panel\_dfs.h@{packages/Eigen.3.3.3/build/native/include/Eigen/src/SparseLU/SparseLU\_panel\_dfs.h}}
...
\DoxyCodeLine{00041\ \ \ \mbox{\hyperlink{struct_eigen_1_1internal_1_1panel__dfs__traits}{panel\_dfs\_traits}}(Index\ jcol,\ StorageIndex*\ marker)}
\DoxyCodeLine{00042\ \ \ \ \ :\ m\_jcol(jcol),\ m\_marker(marker)}
\DoxyCodeLine{00043\ \ \ \{\}}
\DoxyCodeLine{00044\ \ \ \textcolor{keywordtype}{bool}\ update\_segrep(Index\ krep,\ StorageIndex\ jj)}
\DoxyCodeLine{00045\ \ \ \{}
...
\DoxyCodeLine{00052\ \ \ \}}
\DoxyCodeLine{00053\ \ \ \textcolor{keywordtype}{void}\ mem\_expand(IndexVector\&\ \textcolor{comment}{/*glu.lsub*/},\ Index\ \textcolor{comment}{/*nextl*/},\ Index\ \textcolor{comment}{/*chmark*/})\ \{\}}
\DoxyCodeLine{00054\ \ \ \textcolor{keyword}{enum}\ \{\ ExpandMem\ =\ \textcolor{keyword}{false}\ \};}
\DoxyCodeLine{00055\ \ \ Index\ m\_jcol;}
...
\DoxyCodeLine{00062\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_sparse_l_u_impl}{SparseLUImpl<Scalar,StorageIndex>::dfs\_kernel}}(\textcolor{keyword}{const}\ StorageIndex\ jj,\ IndexVector\&\ perm\_r,}
\DoxyCodeLine{00063\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Index\&\ nseg,\ IndexVector\&\ panel\_lsub,\ IndexVector\&\ segrep,}
...
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Index\&\ nextl\_col,\ Index\ krow,\ Traits\&\ traits}
\DoxyCodeLine{00067\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00068\ \{}
\DoxyCodeLine{00069\ \ \ }
...
\DoxyCodeLine{00099\ \ \ \ \ \ \ StorageIndex\ oldrep\ =\ emptyIdxLU;\ }
...
\DoxyCodeLine{00103\ \ \ \ \ \ \ Index\ maxdfs\ =\ xprune(krep);\ }
\DoxyCodeLine{00104\ \ \ \ \ \ \ }
...
\DoxyCodeLine{00233\ \ \ \ \ }
\DoxyCodeLine{00234\ \ \ \ \ \mbox{\hyperlink{class_eigen_1_1_vector_block}{VectorBlock<IndexVector>}}\ repfnz\_col(repfnz,\ nextl\_col,\ m);\ \textcolor{comment}{//\ First\ nonzero\ location\ in\ each\ row}}
\DoxyCodeLine{00235\ \ \ \ \ \mbox{\hyperlink{class_eigen_1_1_vector_block}{VectorBlock<ScalarVector>}}\ dense\_col(dense,nextl\_col,\ m);\ \textcolor{comment}{//\ Accumulate\ a\ column\ vector\ here}}
\DoxyCodeLine{00236\ \ \ \ \ }
\DoxyCodeLine{00237\ \ \ \ \ }
\DoxyCodeLine{00238\ \ \ \ \ \textcolor{comment}{//\ For\ each\ nnz\ in\ A[*,\ jj]\ do\ depth\ first\ search}}
\DoxyCodeLine{00239\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{typename}\ \mbox{\hyperlink{class_eigen_1_1_sparse_compressed_base_1_1_inner_iterator}{MatrixType::InnerIterator}}\ it(A,\ jj);\ it;\ ++it)}
\DoxyCodeLine{00240\ \ \ \ \ \{}
\DoxyCodeLine{00241\ \ \ \ \ \ \ Index\ krow\ =\ it.row();\ }
